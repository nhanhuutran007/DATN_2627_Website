...
settings = Settings(
    ...
    success_metrics_path=Path(os.getenv("AI_SUCCESS_METRICS_PATH", "models/success_metrics.json")),
    success_features_path=Path(os.getenv("AI_SUCCESS_FEATURES_PATH", "models/success_features.json")),
    recommender_index_path=Path(os.getenv("AI_RECOMMENDER_INDEX_PATH", "data/synthetic_campaigns.csv")),
